...
{
    public partial class HireManagement : AyuboDriveTemplateForm
    {
        ...
        public readonly static string _defaultLongTourQuery = "SELECT bookingID, vehicleID, driverID, customerID, packageID, hireStatus as status, startDate, endDate as returned from hireBooking WHERE hiretype = 'Long'";
        public readonly static string _defaultDayTourQuery = "SELECT bookingID, vehicleID, driverID, customerID, packageID, hireStatus as status, startDate, endDate as returned from hireBooking WHERE hiretype = 'Day'";

        public HireManagement(DashboardForm dashboardForm) : base(dashboardForm)
        {
            InitializeComponent();
            HandleTitleBar();
            HideVehicleObjects();
        ...
        {
            //string query = "SELECT * FROM hireBooking WHERE hireType = 'long'";
        ...
        {
            //string query = "SELECT * FROM hireBooking WHERE hireType = 'day'";
        ...
        //
        private void HireBookingManagementForm_Load(object sender, EventArgs e)
        {
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            if (!_rowSelected)
            {
                MessagePrinter.PrintToMessageBox("Please select a hire booking record", "Select a record", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
